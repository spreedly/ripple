...
Support for Rails 5.2.5

h2. 5.2.0 Release

Support for Rails 5.2.4

h2. 5.0.0 Release

Finders not based on keys (notably, `list`) have been removed. They are not needed in production and represent a security concern.
